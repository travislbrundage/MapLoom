(function() {
  var translations = {
    ...
    'added_1_feature': 'Added 1 feature to \'{{layer}}\' via Layer Editor.',
    'modified_1_feature': 'Modified 1 feature in \'{{layer}}\' via Layer Editor.',
    'modified_x_features': 'Modified {{num}} features in \'{{layer}}\' via Layer Editor.',
    'removed_1_feature': 'Removed 1 feature from \'{{layer}}\' via Layer Editor.',
    'applied_via_maploom': 'Applied via Layer Editor.',
    ...
    'composer_publish_tooltip': 'Publish Story',
    'composer_properties_tooltip': 'Story Properties',
    'composer_preview_tooltip': 'Preview Story',
    'add_new_chapter_tooltip': 'To build a new chapter, create it here and then add Chapter Info, Layers, StoryBoxes, and StoryPins.',
    ...
    'storylayers_tooltip': 'Layers are the spatial-temporal data that forms the basis of your Story.',
    'storylayer_visibility_tooltip': 'Temporarily turn on and off the visibility of a layer.',
    'storylayer_style_tooltip': 'Select a Style to use for your Layer. Currently Story supports 4 different style options: Simple, Unique, Graduated and Chloropleth. To learn more about each of these style types, go to ‘Styling Help below.',
    'storylayer_symbol_tooltip': 'Choose the color and size that you’d like for your Layer features.',
    'storylayer_stroke_tooltip': 'Choose the color and thickness of the border lines (or “stroke”) for your features.',
    'storylayer_label_tooltip': 'If you want any text (or “labels”) associated with an attribute in the Layer to appear next to the feature, you can select it here.',
    ...
    'storylayer_alias_tooltip': 'Create a Layer Alias to control how the Layer is referred to in your legend.',
    'storylayer_attributes_tooltip': 'Decide which attributes from your Layer you want to appear when a viewer clicks on a feature, and  decide how you want to refer to the feature. Ideally, you will use a simple description that anyone can understand.',
    'storyboxes_tooltip': 'StoryBoxes let you change the zoom level of the map as your Story moves through time.',
    'storypins_tooltip': 'StoryPins are pop-ups on the map that your viewers can click on while your Story plays. StoryPins help you add more context to your Story, and can include text or embedded media (like a YouTube video or Wiki Commons image).',
    ...
    'choose_your_basemap_tooltip': 'You’ll want to pick the basemap best suited for your Story. For example, a Story about the environment might use Natural Earth, while one about cities might use OpenStreetMap.',
